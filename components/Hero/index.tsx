...
import { AiService } from "../ai-commerce/AiService";
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              <h4 className="flex gap-2 mb-4.5 text-lg font-medium text-black dark:text-white">
                <ShoppingBasket className="text-orange-500"/> <span className="text-green-500 uppercase">First Basket</span> -AI Powered E-Commerce for your daily life 🔥
              </h4>
