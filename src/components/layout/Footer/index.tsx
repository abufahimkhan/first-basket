...
const socialsData: SocialNetworks[] = [
  ...
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://www.facebook.com/profile.php?id=61575319721027",
  },
  {
    id: 3,
    icon: <FaInstagram />,
  ...
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/abufahimkhan",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          <nav className="lg:grid lg:grid-cols-12 mb-8">
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              ...
              >
                <FaBasketShopping className='text-orange-500'/>
